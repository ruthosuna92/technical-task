<script>
    ...
    import TherapistType from "./therapistType.svelte";
    import Country from "./country.svelte";
    import Language from "./language.svelte";
    import {menuFilter} from "../../stores"
    import HeaderFilterResponsive from "./headerFilterResponsive.svelte";
</script>

<div
    class="{ $menuFilter ? "" : "xs:hidden"} xs:fixed xs:h-screen xs:w-full xs:top-0 xs:left-0 flex flex-wrap gap-6 xs:gap-0 overflow-hidden w-full"
>
